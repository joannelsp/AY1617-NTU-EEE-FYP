...
num = 766
while num in (741,742,743,744,745,746,747,749,751,752,753,755,756,757,758,759,760,761,766,767,768,769,770,771,772,773,774,775,776,777,778,779,780,781,782,783,784,785,786,787,788,789,790,791,792,793,794,795,796,797,798):
    x = str(num)+"img.png"
    y = str(num)+"-GT.png"
    z = str(num)+"img_17BRBR_GT.png"
    img = cv2.imread(x)
    b,g,r = cv2.split(img)
    img1 = cv2.imread(y)
    ...
    min_value = np.min(matrix_BRBR)
    max_value = np.max(matrix_BRBR)
